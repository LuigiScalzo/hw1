...
if ($payload) {
    ...
    $stmt = $conn->prepare("INSERT IGNORE INTO dati_artisti (name, image_url) VALUES ( ?, ?)");
    $stmt->bind_param("ss", $artist, $image_url);
    ...
    // Aggiungo il preferito alla tabella preferiti
    $stmt = $conn->prepare("INSERT INTO artists_preferiti (user_id,artist_id) VALUES (?, ?)");
